...
/*Defining the boards. comment a board out when not in use*/
//#define FEATHER_M0
#define ESP_32 //board is TTGO LoRa32-OLED-V1, 
...
static const PROGMEM u1_t NWKSKEY[16] = { 0x25, 0x30, 0x65, 0xE0, 0x8D, 0x62, 0x08, 0xDE, 0x99, 0xB4, 0x2D, 0x53, 0x13, 0x47, 0x17, 0x80 };
...
static const u4_t DEVADDR = 0x26021879; // <-- Change this address for every node!
...
void onEvent (ev_t ev) { //may use the unique cases to do some action, not now in the main tho.
